        ...
        <section class="contact" id="contact">
            <div class="container">
                <div class="row custom-row">
                    ...
                    <div class="col-md-5">
                        <h2>
                            Mastermind,Dhanmondi
                        </h2>
                        <p>
                            <strong>Head Office:</strong> <br>
                            House # 05, Road # 12 (New), <br>
                        ...
                        <p>
                            admin@mastermindschool.org <br>
                            +88 02 55026528, +88 02 55026529, +88 02 58155196, +88 02 58153675
                        </p>
                    </div>
                    <div class="col-md-3">
                        <div class="card contact-card" style="width: 22rem;">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">Working hours:</li>
                                <li class="list-group-item">
                                    <span class="left">Sun-Thu
