            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12 ">
                        ...
                        <p>
                            Admission for the session <strong>2024 – 2025</strong> is open from <strong>1<sup>st</sup> September 2023.</strong>
                        </p>
                        <p>
                            For further admission procedures please contact at the following numbers
                            <span style="color: #0000ff;">
                                <strong> between 9:00 am&nbsp; to &nbsp; 3:00 pm :</strong>
                            </span>
        ...
        <footer>
            ...
            <section class="footer-copyright">
                <div class="container">
                    <div class="row">
                        <div class="col-md-7">
                            <p class="copyright-text">Made With Love By Figmaland All Right Reserved </p>
                        </div>
                        <div class="col-md-5">
